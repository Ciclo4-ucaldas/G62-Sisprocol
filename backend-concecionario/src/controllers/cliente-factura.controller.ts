...
export class ClienteFacturaController {
  ...
  async find(
    ...
    return this.clienteRepository.susFacturas(id).find(filter);
  }
  ...
  async create(
    ...
    return this.clienteRepository.susFacturas(id).create(factura);
  }
  ...
  async patch(
    ...
    return this.clienteRepository.susFacturas(id).patch(factura, where);
  }
  ...
  async delete(
    ...
    return this.clienteRepository.susFacturas(id).delete(where);
  }
}
