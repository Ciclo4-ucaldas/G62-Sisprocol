...
export class VendedorVentaController {
  ...
  async find(
    ...
    return this.vendedorRepository.SusVentas(id).find(filter);
  }
  ...
  async create(
    ...
    return this.vendedorRepository.SusVentas(id).create(venta);
  }
  ...
  async patch(
    ...
    return this.vendedorRepository.SusVentas(id).patch(venta, where);
  }
  ...
  async delete(
    ...
    return this.vendedorRepository.SusVentas(id).delete(where);
  }
}
