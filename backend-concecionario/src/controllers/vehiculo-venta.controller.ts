...
export class VehiculoVentaController {
  ...
  async find(
    ...
    return this.vehiculoRepository.VehVendidos(id).find(filter);
  }
  ...
  async create(
    ...
    return this.vehiculoRepository.VehVendidos(id).create(venta);
  }
  ...
  async patch(
    ...
    return this.vehiculoRepository.VehVendidos(id).patch(venta, where);
  }
  ...
  async delete(
    ...
    return this.vehiculoRepository.VehVendidos(id).delete(where);
  }
}
